...
- HTTP API boundary marker: api/openapi.yaml
- DB boundary marker: db/schema.dbml
...
- Library flag schema source: docs/library/flag-file-schema-v1.md
- Library env override source: docs/library/env-overrides.md
- Library bucketing source: docs/library/bucketing-v1.md
