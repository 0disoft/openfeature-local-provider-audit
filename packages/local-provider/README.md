...
fixtures, redacted audit event generation, missing flag defaults, type mismatch error
results, and a minimal OpenFeature provider adapter.

Deferred features include audit sink wiring, YAML, file watching, CLI, browser support,
